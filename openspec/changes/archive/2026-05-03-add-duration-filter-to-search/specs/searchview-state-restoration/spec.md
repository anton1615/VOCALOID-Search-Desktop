...
- **THEN** SearchView restores Search results, sorting, filters including duration filters, and pagination progress from that list context
...
- **THEN** SearchView restores the saved Search results, query, sorting, filters including duration filters, and pagination progress
...
- **AND** the user changes Search query, sort, duration filters, other filters, or formula filter
